import { getTopMovie, getTopTv } from "../../services";
...
fetchTopMovie();
  ...
  <div className="flex flex-col p-5">
    <label className="text-2xl font-bold mb-5 flex flex-wrap justify-center">Top Rated Movie</label>
    ...
    <label className="text-2xl font-bold mb-5 flex flex-wrap justify-center my-10">Top Rated Tv Show</label>
    <div className="text-md flex-row flex flex-wrap gap-5 justify-center">
