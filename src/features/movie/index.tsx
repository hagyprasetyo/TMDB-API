...
const Movie = () => {
  ...
  <div className="flex flex-col p-5">
    <label className="text-2xl font-bold mb-5 flex flex-wrap justify-center">Now Playing</label>
    {!loading ? (
    ...
    <div className="flex flex-row justify-between">
      <p></p>
      <button onClick={prevPage} className="bg-gray-200 p-2 rounded-sm my-5">Previous</button>
      <button onClick={handlePage} className="bg-gray-200 p-2 rounded-sm my-5">Next</button>
      <p></p>
    </div>
  </div>
  );
